...
#https://connect2.pointclickcare.com/api/public/preview1/orgs/{orgUuid}/
headers = CaseInsensitiveDict()
headers["Accept"] = "application/json"
headers["Authorization"] = 'Bearer ' + tokens['access_token']
payload = {"patientId":"1504968216"}

allergies = requests.get(call_url,headers=headers,params=payload, verify=False,cert=cert)
allergies_data = json.loads(allergies.text)
print(allergies_data)
"""
allergies_data = pd.DataFrame(allergies_data['data'])
#print(facility_data)

allergies_data.to_csv("C:\certs\Allergies.csv")
"""
